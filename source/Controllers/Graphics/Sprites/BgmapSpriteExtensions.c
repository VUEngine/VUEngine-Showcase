...
{
	if(__TOTAL_WORLD_LAYERS <= (uint16)bgmapSprite->index)
	{
		return 0;
	}
...
static int16 BgmapSprite::waveEffect(BgmapSprite bgmapSprite, int32 specialEffectsRowsPerFrame __attribute__((unused)))
{
