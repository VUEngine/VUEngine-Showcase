...
extern uint32 VideoActorVideoL058LTiles[];
extern uint16 VideoActorVideoL058LMap[];
extern uint32 VideoActorVideoL058LTilesFrameOffsets[];
extern uint32 VideoActorVideoR058RTiles[];
extern uint16 VideoActorVideoR058RMap[];
extern uint32 VideoActorVideoR058RTilesFrameOffsets[];
...
CharSetROMSpec VideoSprite1LCharsetSpec =
{
	...
	// Tiles array
	VideoActorVideoL058LTiles,

	// Frame offsets array
	VideoActorVideoL058LTilesFrameOffsets
};
...
CharSetROMSpec VideoSprite1RCharsetSpec =
{
	...
	// Tiles array
	VideoActorVideoR058RTiles,

	// Frame offsets array
	VideoActorVideoR058RTilesFrameOffsets
};
