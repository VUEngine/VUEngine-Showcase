...
extern uint16 BoxActorBoxMap[];
extern uint32 BoxActorBoxTiles[];
...
ColliderROMSpec BoxCollider1ColliderSpec = 
{
	// Component
	{
		// Allocator
...
ComponentSpec* const BoxComponentSpecs[] = 
{
	(ComponentSpec*)&BoxSprite1SpriteSpec,
	(ComponentSpec*)&BoxCollider1ColliderSpec,
	NULL
};
...
ActorROMSpec BoxActorSpec =
{
	...
	// Component specs
	(ComponentSpec**)BoxComponentSpecs,
