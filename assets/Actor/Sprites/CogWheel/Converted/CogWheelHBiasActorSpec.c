...
CharSetROMSpec CogWheelHBiasSprite1CharsetSpec =
{
	...
	// Tiles array
	CogWheelHBiasActorCogWheelTiles,
...
BgmapSpriteROMSpec CogWheelHBiasSprite1SpriteSpec =
{
	{
		// VisualComponent
		{
		...
		(TextureSpec*)&CogWheelHBiasSprite1TextureSpec,
...
ComponentSpec* const CogWheelHBiasComponentSpecs[] = 
{
	(ComponentSpec*)&CogWheelHBiasSprite1SpriteSpec,
	NULL
};

ActorROMSpec CogWheelHBiasActorSpec =
{
	// Class allocator
	__TYPE(Actor),

	// Component specs
	(ComponentSpec**)CogWheelHBiasComponentSpecs,
