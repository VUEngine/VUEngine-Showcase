...
PositionedEntityROMSpec SpritesStageEntities[] =
{
	{NULL, {0,0,0,0}, 0, NULL, NULL, NULL, false},
};

PositionedEntityROMSpec SpritesStageUiEntities[] =
{
...
StageROMSpec SpritesStage =
{
	...
	// entities
	{
		// ui
		{
			(PositionedEntity*)SpritesStageUiEntities,
			__TYPE(UIContainer),
		},
