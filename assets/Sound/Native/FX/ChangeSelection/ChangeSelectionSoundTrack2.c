...
const WaveformData* const ChangeSelection2SoundTrack1SxRAM[] =
{
	&SawWaveForm,
};
...
VSUSoundTrackROMSpec ChangeSelection2SoundTrack1 =
{
	// SoundTrack
	{
		// Allocator
	...
	/// SxRAM pointers
	(WaveformData**)ChangeSelection2SoundTrack1SxRAM,
