...
#define __PLUGIN_AUTOMATIC_PAUSE_USE_LOW_POWER_ACTOR (true)
...
#define __PLUGIN_ADJUSTMENT_SCREEN_VUENGINE_USE_LOW_POWER_ACTOR (true)
...
#define __PLUGIN_AUTOMATIC_PAUSE_SELECTION_SCREEN_USE_LOW_POWER_ACTOR (true)
...
#define __PLUGIN_LANGUAGE_SELECTION_SCREEN_USE_LOW_POWER_ACTOR (true)
...
#define __PLUGIN_PRECAUTION_SCREEN_USE_LOW_POWER_ACTOR (true)
